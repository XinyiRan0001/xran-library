...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <!-- Activity 6: Create a list containing author names and their birth years. Hint: Make use of the v-for directive to iterate through the array of authors. -->
      <ul>
      ...
      <!-- Activity 7: Create a list containing author names and their birth years. Hint: Make use of the v-for directive to iterate through the array of authors that you have filtered out. -->
      ...
      <p>Famous works:</p>
      <ul>
        <!-- Activity 8: Create a list of all famous works. Hint: Use the v-for directive to iterate through the array of authors that you have filtered out. -->
        <ul>
      ...
      <!-- Activity 9: Create a list of Austen's works. Hint: Use the v-for directive to iterate through the array of authors that you have filtered out. -->
      <ul>
